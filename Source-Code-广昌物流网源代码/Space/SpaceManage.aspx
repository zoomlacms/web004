<%@ page language="C#" autoeventwireup="true" inherits="Space_SpaceManage, App_Web_sgwbynrr" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>我的聚合页</title>
...
<body>
            ...
            <h1>
                ...
                您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                    ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                        ...
                        &gt;&gt; </span><span><a title="修改密码" href="SpaceManage.aspx">我的聚合</a></span></span>
            </h1>
        </div>
        <div class="cleardiv">
        </div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
        <tr class="tdbg">
            <td align="left" style="width: 8%">
                <a href="SpaceManage.aspx">所有内容</a>
            </td>
            <td align="left" style="width: 80%">
                聚合分类：<asp:Label ID="lblLabel" runat="server" Text="Label"></asp:Label>
            </td>            
    ...
    <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID" PageSize="10" 
                OnRowCommand="Lnk_Click" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="Egv_RowDataBound"  >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="标题">
                        ...
                        <ItemTemplate>
                            <a href='/User/Content/ShowPubList.aspx?ID=<%# Eval("GeneralID") %>'>
                                <%# Eval("Title")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href='/User/Content/ShowPubList.aspx?ID=<%# Eval("GeneralID") %>'>预览</a>&nbsp;&nbsp;<a href="<%# GetUrl(Eval("GeneralID", "{0}"))%>"
                                target="_blank">访问</a>
                            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Edit" CommandArgument='<%# Eval("GeneralID") %>'>修改</asp:LinkButton>
                            <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Del" CommandArgument='<%# Eval("GeneralID") %>'
