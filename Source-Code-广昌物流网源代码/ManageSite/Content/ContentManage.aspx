<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.ContentManage, App_Web_tr1cvwom" viewStateEncryptionMode="Never" %>
...
<body onload="pload()">
    ...
    <div class="column">
        ...
        <div style="padding-left: 10px; text-align: left">
            ...
            <asp:LinkButton ID="Button2" CausesValidation="false" runat="server" Text="批量推荐" OnClientClick="if(!IsSelectedId()){alert('请选择项');return false;}else{return confirm('你确定要将所有选择项设为推荐吗？')}"
                 OnClick="Button2_Click" />
            <asp:Label ID="Label3" runat="server" Text="&nbsp;|"></asp:Label>
            <asp:LinkButton ID="Button3" CausesValidation="false" runat="server" Text="取消推荐" OnClientClick="if(!IsSelectedId()){alert('请选择项');return false;}else{return confirm('你确定要取消所有选择项推荐吗？')}"
            ...
            <asp:LinkButton ID="LinkButton4" runat="server" Text="投稿" 
        ...
        <div style="padding-left: 10px; text-align: left">
            <b>内容操作： </b><asp:Label ID="lblAddContent" runat="server" Text="Label"></asp:Label>
        </div>
        <div style="background-position: center 50%; width: 100%; height: 10px; background-image: url(../images/line.gif);
            background-repeat: repeat-x">
        </div>
