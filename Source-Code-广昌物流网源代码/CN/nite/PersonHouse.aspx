<%@ page language="C#" autoeventwireup="true" inherits="CN_nite_PersonHouse, App_Web_mzd1pfou" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="gvCard" runat="server">
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td height="22" align="center">
                        <%#GetComapny(Eval("ComapnyID").ToString())%>
                    </td>
                    <td height="22" align="center">
                        <%#GetE(Eval("Expires").ToString())%>
                    </td>
                    <td height="22" align="center">
                        <%#GetTime(Eval("Dredgetime").ToString(),Eval("RJob").ToString())%>
                    </td>
                    <td height="22" align="center">
                    <%#GetHouse(Eval("Expires").ToString(), Eval("Rid").ToString(), Eval("RJob").ToString())%>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
