<%@ page language="C#" autoeventwireup="true" inherits="CN_nite_CompanyVideo, App_Web_vwxdsjzz" viewStateEncryptionMode="Never" %>
...
<body>
            ...
            <h1>
                ...
                您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                    ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                        ...
                        &gt;&gt; </span><span>视频管理</span>&nbsp;&nbsp;&nbsp;【<a href="AddVideo.aspx" ><font
    ...
    <ItemTemplate>
     <a href="ShowVideo.aspx?ID=<%#Eval("Vid") %>"><%#Eval("VidTitle")%></a> 
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
        <a href="AddVideo.aspx?ID=<%#Eval("Vid") %>">修改</a> | 
        <a href="ShowVideo.aspx?ID=<%#Eval("Vid") %>">预览</a>
    </ItemTemplate>
    </asp:TemplateField>
    </Columns>
    </asp:GridView>
