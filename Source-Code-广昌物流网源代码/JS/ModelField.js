...
function SelectModelType()
{
    ...
    { 
        ...
        if(TypeCount[i].checked)
        {
            ...
            if (TypeCount[i].value == "PicType" || TypeCount[i].value == "MultiPicType" || TypeCount[i].value == "FileType" || TypeCount[i].value == "SuperLinkType" || TypeCount[i].value == "ColorType")
            {                
