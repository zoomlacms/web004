<%@ page language="C#" autoeventwireup="true" inherits="OrderOver, App_Web_lhavxf0l" viewStateEncryptionMode="Never" %>
...
<div class="s_bright">
	<div class="rg_inout">
	    ...
	    <ul>
            ...
            <asp:Button ID="Button3" runat="server" Text="PayPal支付" OnClick="Button3_Click" />&nbsp;&nbsp;
