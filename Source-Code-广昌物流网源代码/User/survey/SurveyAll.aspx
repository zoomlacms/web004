<%@ page language="C#" autoeventwireup="true" inherits="User_survey_SurveyAll, App_Web_fgfucaeb" viewStateEncryptionMode="Never" %>
    ...
    <div>
       ...
       <asp:GridView ID="Gdv" RowStyle-HorizontalAlign="Center" DataKeyNames="SurveyID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="100%" OnPageIndexChanging="Egv_PageIndexChanging"  EmptyDataText="无相关数据">
            <Columns>   
               ...
               <%-- <asp:TemplateField HeaderText="问卷内容">
                    <ItemTemplate>                                
                    <a href="SurveyScore.aspx?surveyID=<%#Eval("SurveyID") %>"> <%# Eval("SurContent")%></a> 
                    </ItemTemplate>
                     <ItemStyle  CssClass="tdbg" HorizontalAlign="Center" />
                     <HeaderStyle Width="30%" />
                </asp:TemplateField>    --%>
