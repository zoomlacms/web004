<%@ page language="C#" autoeventwireup="true" inherits="User_ConstPassen, App_Web_1f4rxn1h" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head id="Head1" runat="server">
<title>会员中心 >> 常用客户管理</title>
    ...
    <h1>
        您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
            ID="LblSiteName" runat="server" Text=""></asp:Label></a></span><span> &gt;&gt;
                ...
                &gt;&gt; </span><span><a title="常用客户" href="/User/ConstPassen.aspx">常用客户管理</a></span></span>
        <a href="AddConstPassen.aspx">[添加客户]</a></h1>
</div>
<div class="cleardiv">
</div>
</div>
<div class="us_seta"  style="margin-top:5px;"><h1 align="center">我的常用客户</h1></div>
<table width="100%" cellpadding="2" cellspacing="1">
        ...
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
               ...
               <td height="24" align="center">
                ...
                <td height="24" align="center">
                   <%#GetCardType(Eval("CreID","{0}"))%>
                </td>
                <td height="24" align="center">
                  <%#GetCardCode(Eval("CreID","{0}"))%>
                </td>
                <td height="24" align="center">
                 <%#Eval("Sex")%>
                </td>
                <td height="24" align="center">
                   <a href="AddConstPassen.aspx?menu=edit&id=<%#Eval("id") %>">修改</a> <a href="?menu=delete&id=<%#Eval("id") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</a>
                </td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
    ...
    <tr>
        <td height="24" colspan="7">
            <asp:Button ID="Button1" class="i_bottom"  Text="批量删除" runat="server"
                OnClientClick="if(!IsSelectedId()){alert('请选择内容');return false;}else{return confirm('不可恢复性删除数据,你确定将该数据删除吗？');}" 
