<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move5, App_Web_hqpcq1fi" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_topinfo" style="overflow: hidden; width:98%">
            <table border="0" class="us_showinfo" align="center" width="100%" cellpadding="0"
                ...
                <tr>
                    ...
                    <td width="41%">
                        &nbsp;<asp:DropDownList ID="SmokeDropDownList" Width="177px" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td width="42%">
                        &nbsp;
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:DropDownList ID="DrinkDropDownList" Width="177px" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:TextBox ID="Comtxt" runat="server" Width="170px"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2" valign="top">
                        &nbsp;<textarea id="TextArea1" runat="server" style="width: 203px; height: 89px"></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td valign="top">
                        &nbsp;<textarea id="Textarea2" runat="server" style="width: 203px; height: 89px"></textarea>
                    </td>
                    <td>
