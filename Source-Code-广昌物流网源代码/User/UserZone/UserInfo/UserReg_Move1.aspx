<%@ page language="C#" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move1, App_Web_hqpcq1fi" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_topinfo" style="overflow: hidden; width: 98%">
            <table border="0" class="us_showinfo" width="100%" align="center" cellpadding="0"
                ...
                <tr valign="top">
                    ...
                    <td width="41%">
                        &nbsp;<asp:TextBox ID="lblhoney" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height: 26px">
                        &nbsp;<asp:TextBox ID="txtrealname" runat="server" Width="140px"></asp:TextBox>
                    </td>
                    <td style="height: 26px">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:TextBox ID="txtbir" runat="server" Width="140px" OnFocus="setday(this)"></asp:TextBox>如：2008-08-08<br />
                        生肖：<asp:Label ID="shengxiao" runat="server"><%=GetTree(Convert.ToDateTime(txtbir.Text))%></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp
                        星座：<asp:Label ID="xingzuo" runat="server" Text=""><%=GetConstellation(Convert.ToDateTime(txtbir.Text))%></asp:Label>
                    </td>
                    <td>
                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtbir"
                            ErrorMessage="出生日期不能为空"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                ID="RegularExpressionValidator2" runat="server" ErrorMessage="请输入正确的出生日期" ValidationExpression="^\d{4}-\d{2}-\d{2}$"
                                ControlToValidate="txtbir"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height: 22px">
                        ...
                        <asp:TextBox ID="txtNum" runat="server" Width="200px" MaxLength="18"></asp:TextBox>
                    </td>
                    <td style="height: 22px">
                    </td>
                </tr>
