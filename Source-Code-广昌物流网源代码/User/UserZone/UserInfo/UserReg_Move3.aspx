<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move3, App_Web_hqpcq1fi" viewStateEncryptionMode="Never" %>
            ...
            <div class="us_showinfo">
                <h1>
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ...
                            </span><span><a title="会员中心" target="_top" href='<%=ResolveUrl("~/User/Default.aspx")%>'>会员中心</a></span>&gt;&gt;我的详细资料
                    </h1>
            </div>
            <div class="cleardiv">
            </div>
            ...
            <table border="0"  class="us_showinfo" align="center" width="100%"  cellpadding="0" cellspacing="0">
                <tr>
                    <td align="right" width="17%">
                        身高：</td>
                    <td width="60%">
                        &nbsp;<asp:TextBox ID="Staturetxt" runat="server" Width="49px" ReadOnly="true"></asp:TextBox>Cm</td>
                    <td >
                        &nbsp;<asp:CompareValidator ID="CompareValidator2"
                                runat="server" ControlToValidate="Staturetxt" ErrorMessage="请输入正确的身高信息" Operator="DataTypeCheck"
                ...
                <tr>
                    <td align="right">
                        体重：</td>
                    <td>
                        &nbsp;<asp:TextBox ID="Avoirtxt" runat="server" Width="48px"></asp:TextBox>Kg</td>
                    <td>
                        &nbsp;<asp:CompareValidator ID="CompareValidator3"
                                runat="server" ControlToValidate="Avoirtxt" ErrorMessage="请输入正确的体重信息" Operator="DataTypeCheck"
                                Type="Double"></asp:CompareValidator></td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    <td align="right">
                        外貌自评：</td>                                       
                    <td>
                        <asp:CheckBoxList ID="facey" runat="server" RepeatColumns="4" 
                ...
                <tr>
                    <td align="right" >
                        体型：</td>
                    <td >
                        &nbsp;<asp:DropDownList ID="ddlSomato" Width="177px" runat="server">
                        </asp:DropDownList></td>
                    <td >
                        </td>
                </tr>
                ...
                <tr>
                    <td align="right">
                        所学专业：</td>
                    <td>
                    &nbsp;<asp:DropDownList ID="Zhuan" Width="177px" runat="server">
                        </asp:DropDownList></td>
                    <td>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="right">
                        工作状态：</td>
                    <td>
                    &nbsp;<asp:DropDownList ID="JobStatus" Width="177px" runat="server">
                        </asp:DropDownList></td>
                    <td>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                        事业前景：</td>
                    <td>
                    &nbsp;<asp:DropDownList ID="JobFuture" Width="177px" runat="server">
                        </asp:DropDownList></td>
                    <td>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="height: 22px">
                        &nbsp;<asp:DropDownList ID="Nationtxt" Width="177px"  runat="server">
                ...
                <tr>
                    <td align="right">
                        家中排行：</td>
                    <td>
                    &nbsp;<asp:DropDownList ID="BrotherDropDownList"  Width="177px" runat="server">
                        </asp:DropDownList></td>
                    <td></td>
                </tr>
                <tr>
                    <td align="right" style="height: 26px">
                        语言能力：</td>
                    <td style="height: 26px">
                        &nbsp;<asp:DropDownList ID="LanguageDropDownList" Width="177px"  runat="server">
                        </asp:DropDownList></td>
                    <td style="height: 26px">
                        &nbsp;</td>
                </tr>
                 <%--<tr>
                    <td align="right" style="height: 26px">
                     ...
                     <td style="height: 22px">
                        ...
                        市：<asp:DropDownList ID="ddlCity" Width="150px" runat="server" >
                        </asp:DropDownList></td>                   
