<%@ page language="C#" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move6, App_Web_hqpcq1fi" viewStateEncryptionMode="Never" %>
    ...
    <div style="margin: auto; width: 100%">
        <div class="us_topinfo">
            <div class="us_showinfo">
                <h1>
                    您现在的位置：<span id="YourPosition"></span><span><a title="网站首页" href="/" target="_top"><asp:Label
        ...
        <div class="us_topinfo" style="overflow: hidden; width:98%">
            <table border="0" class="us_showinfo" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtZipCode"
                            ErrorMessage="请输入正确的邮政编码" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtQQ"
                            ErrorMessage="请输入正确的QQ号" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtUC"
                            ErrorMessage="请输入正确的UC号" Operator="DataTypeCheck" Type="Double"></asp:CompareValidator>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<asp:TextBox ID="txtHomePage" runat="server" TextMode="MultiLine" Columns="2"
