<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Default, App_Web_nsqyxzui" viewStateEncryptionMode="Never" %>
        ...
        <asp:View ID="View1" runat="server">
                    ...
                    <h1>
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span>&gt;&gt;
                                ...
                                会员中心</a></span><span> &gt;&gt; </span><span><a title="我的空间" href="/User/Userzone/Default.aspx">
                                    我的空间</a></span></span>
                    </h1>
                </div>
                <div class="cleardiv">
            ...
            <div class="us_topinfo" style="margin-top: 10px; width:98%">
                <a href="/user/userzone/Default.aspx">修改空间基本信息</a> | <a href="/user/userzone/StyleSet.aspx">
                    设定空间模板</a> | <a href="/ShowList.aspx?id=<%=id %>" target="_blank">个人空间首页</a></div>
            <div class="us_topinfo" style="margin-top: 10px; width:98%">
                ...
                <li style="width: 120px; float: left; line-height: 30px; text-align: right">空间简介：
                </li>
                <li style="width: 70%; line-height: 30px; font-weight: bold;">
                    <textarea id="textareacontent" class="U_input" style="width: 294px; height: 138px" runat="server"></textarea></li>
                    <li style="width: 120px; float: left; line-height: 30px; text-align: right">推广地址： 
                </li>
                <li style="width: 70%; line-height: 30px">
                ...
                <li>
                    <asp:Button ID="EBtnSubmit" class="R_input" Font-Bold="True" ForeColor="White" runat="server" OnClick="EBtnSubmit_Click" 
                        Text="信息提交" style="width: 78px" />
                    &nbsp;
                    <input ID="Button1" class="R_input" onclick="javascript:history.go(-1)" type="button" 
                        value="返  回" style="color: #FFFFFF; font-weight: bold;" />
                    <asp:HiddenField ID="HiddenField1" runat="server" />
                </li>
            </div>
        </asp:View>
        <asp:View ID="View2" runat="server">
            系统未开启此功能，请在后台-系统设置-网站参数设置启用该功能。
        </asp:View>
    </asp:MultiView>
    <!-- str -->
</div>
