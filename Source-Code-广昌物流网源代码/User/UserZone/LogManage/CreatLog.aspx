<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="User_UserZone_LogManage_CreatLog, App_Web_z03vtqgs" viewStateEncryptionMode="Never" %>
...
<body>
   ...
   <div class="us_topinfo" style="width:98%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="center" style="width: 771px">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td colspan="2" style="height: 44px" align="left">
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="90%">
                                    <tr>
                                        <td align="left">
                                            标题：<asp:TextBox ID="txtTitle" runat="server" Width="379px"></asp:TextBox><asp:Label
                                                ID="lblErr" Text="" runat="server"></asp:Label>
                                            <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle"
                                                    Display="Dynamic" ErrorMessage="请填写标题" Font-Size="10pt"></asp:RequiredFieldValidator> --%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                            分类：<asp:DropDownList ID="dropLogType" runat="server">
                                            </asp:DropDownList>
                                                ...
                                                CKEDITOR.replace('infoeditor',
                            {
                                ...
                                //]]>
                                    ...
                                    <tr>
                                        <td align="left">
                                            日志中提到的好友：<asp:TextBox ID="txtFrd" runat="server" Height="46px" TextMode="MultiLine"
                        ...
                        <tr>
                            <td>
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                <asp:Button ID="btnSave" runat="server" Text="保存为草稿" OnClick="btnSave_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
