<%@ page language="C#" autoeventwireup="true" inherits="SelfLogManage, App_Web_z03vtqgs" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td rowspan="2" style="width: 110px">
                &nbsp;<asp:Image ID="Image1" runat="server" ImageUrl="../Images/blog.gif" />
            </td>
            <td>
                &nbsp;我的日志
            </td>
        ...
        <tr>
            <td valign="top" style="height: 16px">
                &nbsp;<a href="CreatLog.aspx">写新日志</a> &nbsp;|&nbsp;
                <asp:LinkButton ID="lbtnManage" runat="server">我的日志</asp:LinkButton>
            </td>
        </tr>
    </table>
    <%--<div class="nav">
                <ul>
                    <li class="nav_bg1"><a href="SelfLogManage.aspx" target="_blank">我的日志</a></li>
                    <li class="nav_bg2"><a href="#" >与我相关的日志</a></li>
                    <li class="nav_bg2"><a href="#" >草稿箱</a></li>
                </ul>
            </div>--%>
    <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="212,208,200">
        <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LogTitle") %>'></asp:Label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CreatDate") %>'></asp:Label>(分类:<asp:Label
                                                            ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LogTypeID") %>'></asp:Label>)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2" style="background: 247,247,247">
                                                        &nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <a href="LogReadCriticism.aspx?LogID=<%#DataBinder.Eval(Container.DataItem,"ID")%>">
                                                            阅读</a>(<asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ReadCount") %>'></asp:Label>)
                                                    </td>
                                                    <td>
                                                        <a href="LogReadCriticism.aspx?LogID=<%#DataBinder.Eval(Container.DataItem,"ID")%>">
                                                            评论</a>(<asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CriticismCount") %>'></asp:Label>)
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            <td style="width: 2px" bgcolor="#FFFFFF">
                &nbsp;
            </td>
                        ...
                        <td>
                            <asp:GridView ID="gvLogType" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbtnLogTypeList" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LogTypeName") %>'
                                                OnClick="lbtnLogTypeList_Click"></asp:LinkButton>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="lbtnLogDate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CreatDate","{0:yyyy年MM月dd日}") %>'
                                                            OnClick="lbtnLogDate_Click"></asp:LinkButton>
                                                        (<asp:Label ID="labDateCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ReadCount") %>'></asp:Label>)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="background: 247,247,247">
                                                    </td>
                                                </tr>
                                            </table>
                                        </ItemTemplate>
