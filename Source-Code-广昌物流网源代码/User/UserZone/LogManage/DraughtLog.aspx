<%@ page language="C#" autoeventwireup="true" inherits="DraughtLog, App_Web_z03vtqgs" viewStateEncryptionMode="Never" %>
            ...
            <tr>
                <td style="width: 80%" bgcolor="#FFFFFF" valign="top">
                    <asp:GridView ID="gvLog" runat="server" AutoGenerateColumns="False" Width="100%"
                        GridLines="None" CellPadding="4" DataKeyNames="ID" ShowHeader="False">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                            ...
                                            <td>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href ="CreatLog.aspx?LogID=<%#DataBinder.Eval(Container.DataItem,"ID")%>&where=2">编辑</a>
                                                            &nbsp;|&nbsp;
                                                            <asp:LinkButton ID="lbtnDelete" runat="server"  OnClientClick="return confirm('确定删除吗？');">删除</asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
