<%@ page language="C#" autoeventwireup="true" inherits="LogTypeMange, App_Web_z03vtqgs" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td align="left">
                <asp:Label ID="labErr" runat="server" Font-Size="20pt" ForeColor="Red"></asp:Label></td>
        </tr>
    </table>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td colspan="2" style="height: 44px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../Images/LogType.gif" />
                &nbsp; 日志类别管理 &nbsp; &nbsp; &nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 47px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日志类别名称：<asp:TextBox ID="txtTypeName" runat="server"
                                MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                    runat="server" ErrorMessage="请填写类别名称" ControlToValidate="txtTypeName" Display="Dynamic"
                    ...
                    <tr>
                        ...
                        <tr>
                        <td>&nbsp;访问权限：</td>
                        <td><asp:DropDownList ID="dropReadAre"
                                runat="server" onChange="dropChang()" >
                            ...
                            <td>
                                ...
                                TextMode="Password" MaxLength="10"></asp:TextBox></span> &nbsp;&nbsp;
                            </td>
                            <td>
                            <asp:Button ID="btnAddType" runat="server" Text="增加分类" OnClick="btnAddType_Click" />
                            </td>
                        </tr>
                        </table>
                            </td>
                ...
                <asp:GridView ID="GridView1" Width="100%" DataKeyNames="ID" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating" >
                    <Columns>
                        ...
                        <HeaderStyle Width="35%" />
                            ...
                            <td><asp:Panel ID="Panel1" runat="server" Visible="false">设置密码：<asp:TextBox ID="txtPWD" Width="50px" TextMode="password"  runat="server" MaxLength="10"></asp:TextBox></asp:Panel></td>
                            </tr>
                            </table>
                                
                            </EditItemTemplate>
                            <ItemTemplate>
                                <%#GetType(DataBinder.Eval(Container.DataItem, "LogArea").ToString())%>
                            </ItemTemplate>
                             <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
