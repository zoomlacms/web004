<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_SetCenter_SC_Friendfactor, App_Web_jor4nygm" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_topinfo">
            <div class="us_showinfo">
                <h1>
                    ...
                    <span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_top">会员中心</a></span>&gt;&gt;设置中心&gt;&gt;征友条件
                </h1>
            </div>
            <div class="cleardiv">
            </div>
