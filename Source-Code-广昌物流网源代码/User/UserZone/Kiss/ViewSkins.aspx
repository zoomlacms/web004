<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Kiss_ViewSkins, App_Web_kiyaojyj" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_topinfo">
            <div class="us_showinfo">
                <h1>
                    ...
                    <span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_top">会员中心</a></span>&gt;&gt;设置中心&gt;&gt;我的秋波
                </h1>
            </div>
            <div class="cleardiv">
            </div>
