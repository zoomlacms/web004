<%@ page language="C#" autoeventwireup="true" inherits="User_AddConstPassen, App_Web_1f4rxn1h" viewStateEncryptionMode="Never" %>
...
<body>
            ...
            <h1>
                您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                    ...
                    <span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span>
                        &gt;&gt; </span><span><a title="修改密码" href="/User/ConstPassen.aspx">常用客户管理</a></span></span>
    ...
    <table width="100%" cellpadding="2" cellspacing="1">
        ...
        <tr>
         ...
         <tr>
            <td align="right" style="font-weight:bold" class="style2">
            证件类型:
            </td>
            <td class="style2">
