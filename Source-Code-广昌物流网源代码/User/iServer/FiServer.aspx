<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_FiServer, App_Web_5ytlacot" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_showinfo">
            您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
                <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span>
                    &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx">会员中心</a></span><span>
                                    ...
                                    <asp:Repeater ID="resultsRepeater_w" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr align="center" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                                                ...
                                                <td>
                                                    <a href="FiServerInfo.aspx?QuestionId=<%#Eval("QuestionId")%>">
