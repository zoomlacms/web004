<%@ page language="C#" autoeventwireup="true" inherits="User_MySubscription, App_Web_5jpyuwhl" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="s_bright" style="margin: auto; text-align: center; float: none; width: 100%;">
                ...
                <h1>
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                            ...
                            &gt;&gt; </span><span><a title="我的订阅管理" href="MySubscription.aspx">订阅管理</a></span></span>
                </h1>
            </div>
            <div class="cleardiv">
            </div>
        ...
        <div class="us_seta" id="Tabs0" style="margin-top: 10px;">
            <h1 style="text-align: center">
                <asp:Label ID="Label1" runat="server" Text="我的订阅管理"></asp:Label></h1>
            <asp:Panel ID="Orderlist" runat="server" Width="100%">
                <ul style="background-color: Blue">
                    <li style="width: 18%; float: left; line-height: 30px; text-align: center; background-color: #FFF5EC">
                        订阅编号 </li>
                ...
                <asp:Repeater ID="MySub" runat="server" OnItemCommand="MySub_ItemCommand" 
                    onitemdatabound="MySub_ItemDataBound">
                    <ItemTemplate>
                        <ul >
                           ...
                           <li style="width: 20%; float: left; display: block; line-height: 28px; text-align: center;">
                              <asp:LinkButton ID="lbDel" runat="server" CommandName="Del" CommandArgument='<%# Eval("Id") %>'>删除</asp:LinkButton></li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
                <ul>
                    ...
                    <span style="width: 350px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;<%--<asp:Button ID="btn_DeleteRecords" runat="server" OnClientClick="return judgeSelect();" Text="删除选中记录" OnClick="btn_DeleteRecords_Click" />--%></span>
                    ...
                    onselectedindexchanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>页 </li>
                </ul>
            </asp:Panel>
        </div>
    </div>
