<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Registers, App_Web_1f4rxn1h" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript" src="/js/RiQi.js"></script>
    ...
    <div id="m_top">
        ...
        <h1 style="float: right;">
            <ul>
                <li><a href="../">首页</a></li><li><a href="###">新闻</a></li><li><a href="###">图库</a></li><li>
                    <a href="###">下载</a></li><li><a href="###">商城</a></li><li><a href="###">论坛</a></li><li
                        style="float: right; width: 140px; background: url();"><a href="javascript:alert('设为首页');">
                            设为首页</a> | <a href="javascript:alert('加入收藏');">加入收藏</a></li></ul>
        </h1>
    </div>
    <!-- 正文布局 -->
    <div class="s_body">
