<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_MyCoruse, App_Web_02adz3d5" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_topinfo" style="width: 98%">
        ...
        <div style="width: 100%">
            <table width="100%;">
                ...
                <asp:Repeater ID="rep" runat="server" OnItemDataBound="rep_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                                <asp:HiddenField ID="hfId" runat="server" Value='<%# Eval("CourseID") %>' />
                            ...
                            <td align="center">
                                <%#GetClass(Eval("ClassID", "{0}"),Convert.ToInt32( Eval("ID").ToString()), "1")%>
                            </td>
                            <td align="center">
                                <%#GetClass(Eval("ClassID", "{0}"), Convert.ToInt32(Eval("ID").ToString()), "3")%>
                            </td>
                            <td align="center">
                                <%#GetState(Eval("ClassID", "{0}"))%>
                            </td>
                            <td align="center">
                                <%#getStartLesson(Convert.ToInt32(Eval("ID").ToString()), Convert.ToInt32(Eval("ID").ToString()))%>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="5" style="width: 100%">
                                <div id="DetDiv<%#Eval("ID") %>" style="display: none;">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:UpdatePanel ID="upStudy" runat="server">
                                                            <ContentTemplate>
            ...
            <asp:UpdatePanel ID="upSpare" runat="server">
            </asp:UpdatePanel>
        </div>
    </form>
</body>
