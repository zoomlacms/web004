<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_CreateCourse, App_Web_02adz3d5" viewStateEncryptionMode="Never" %>
            ...
            <h1>
                您现在的位置：<span id="Span1"><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName"
                    runat="server" Text=""></asp:Label></a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx"
                        target="_blank">会员中心</a>&gt;&gt; <a href="ApplicationCourese.aspx">申请新课</a></span></h1>
        </div>
        <div class="cleardiv">
        </div>
    </div>
