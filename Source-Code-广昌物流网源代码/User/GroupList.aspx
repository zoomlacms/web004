<%@ page language="C#" autoeventwireup="true" inherits="User_GroupList, App_Web_5jpyuwhl" viewStateEncryptionMode="Never" %>
    ...
    <div style="width: 100%">
        ...
        <div class="us_topinfo" style="width: 98%">
            <div class="us_showinfo">
                <h1>
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><span
                        id="WebUserControlTop2_1_LblSiteName">逐浪CMS</span></a></span><span> &gt;&gt; </span>
                        <span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span>
                            &gt;&gt; </span><span><a href="javascript:void(0)">商城管理</a></span><span> &gt;&gt;
                        </span><span><a title="我的团定" href="/User/GroupList.aspx">我的团定</a></span></span>
                </h1>
            </div>
            <div class="cleardiv">
            </div>
