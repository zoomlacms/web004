<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_codesearch, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>自定义搜索框</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="user_table user_table1">
    ...
    <td><input name="w" type="text" class="code_input" id="Text1" value="180" size="6" />px&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;高
       ...
       <img onclick="SelectColor(this,'bColor');" src="/App_Themes/AdminDefaultTheme/images/selectclolor.gif"
                        align="absmiddle" style="border-width: 0px; cursor: pointer" /></td>
    </tr>
    <tr>
