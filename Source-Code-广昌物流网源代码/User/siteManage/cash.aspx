<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_cash, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
        ...
        <table cellspacing="0" width="100%" cellpadding="0" class="user_table">
            ...
            <tr>
                ...
                <td style="padding: 5px">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtOfName"
                        ErrorMessage="请填写开户人真实姓名!"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
