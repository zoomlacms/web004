<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_shoplist, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>博客内容推广</title>
...
<div class="user_con">
 ...
 <div align="center">共<asp:Label ID="Allnum" runat="server" Text=""></asp:Label>条信息
    ...
    <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true"  class="l_input" Width="16px" Height="16px" ontextchanged="txtPage_TextChanged" ></asp:TextBox>
         ...
         AutoPostBack="True" onselectedindexchanged="DropDownList1_SelectedIndexChanged"> </asp:DropDownList>页</div>
</div>
</form>
</body>
</html>
