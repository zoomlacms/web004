<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_forms, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>业绩概况</title>
...
<div class="todayinfo">
  ...
  <div id="todaytips">今日提交<strong> <asp:Label ID="lblfOrdernum" runat="server"></asp:Label></strong>个订单
  &nbsp;，<asp:HyperLink ID="hlDetail" runat="server">查看详情</asp:HyperLink></div>
</div>
