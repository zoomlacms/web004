<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_Default, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
obj.id='nav_current'
  ...
  <div id="main_user">
      ...
      <div class="user_con">
     <iframe src="forms.aspx" height="700px" frameborder="0" marginwidth="0" marginheight="0" scrolling="auto" width="100%"
        allowtransparency="true" id="main_right" name="main_right" style="padding-left: 4px;
        overflow-x: hidden; overflow-y: auto;" ></iframe>
     </div>
