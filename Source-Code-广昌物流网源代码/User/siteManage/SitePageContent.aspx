<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_SitePageContent, App_Web_w4iwwbti" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>分站内容设置</title>
...
<%--
<iframe name="page" width="100%" height="550px" id="page" src="../Pages/Modifyinfo.aspx" frameborder="0" scrolling="no"></iframe>--%>
<div class="user_con">
<div style="margin-top: 10px;">
    ...
    <div class="us_seta" style="margin-top: 5px; ">
        <table>
            ...
            <tr>
                <td>&nbsp;</td>
                <td><asp:HiddenField ID="hfid" runat="server" />
                    <asp:HiddenField ID="hfurl" runat="server" />
                    <textarea id="areurl" runat="server"  style="width:100%;height:100px"></textarea></td>
            </tr>
        </table>
    </div>
</div>
<div align="center" style="border:1px solid #b8d2f7">
