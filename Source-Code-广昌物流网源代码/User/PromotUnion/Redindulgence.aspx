<%@ page language="C#" autoeventwireup="true" inherits="PromotUnion_Redindulgence, App_Web_waugczbx" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <div>
            ...
            <div style="margin-top: 29px; font-size: 14px; color: #313131;">
                E-Mail<span style="margin-left: 138px;">朋友姓名</span><span style="margin-left: 88px;
                    +margin-left: 90px;">邀请人</span></div>
            <div style="margin-top: 10px;">
                <asp:TextBox ID="email_name" runat="server" name="email_name" Style="width: 170px;
                    border: 1px solid #C9C9C9;"></asp:TextBox>
                <asp:TextBox ID="f_name" runat="server" name="f_name" Style="width: 134px; border: 1px solid #c9c9c9;
                ...
                <asp:Button ID="btn" runat="server" Text="发送红包" Style="width: 74px; height: 21px;
                    border: 0; vertical-align: top; margin-left: 6px;" OnClientClick="return checkemail();"  OnClick="btn_Click" /></div>
