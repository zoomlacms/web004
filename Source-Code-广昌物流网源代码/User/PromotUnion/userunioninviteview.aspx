<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_userunioninviteview, App_Web_waugczbx" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div>
     <div class="us_showinfo"><h1>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="userunioninviteview.aspx">我的赚钱记录</a></span>&nbsp;</span> </h1>
        </div>
