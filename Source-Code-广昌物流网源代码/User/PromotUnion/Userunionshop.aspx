<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_Userunionshop, App_Web_waugczbx" viewStateEncryptionMode="Never" %>
    ...
    <div>
         ...
         <div style="background:#EAF5FE; margin-top:12px;">
            ...
            <div style="height:22px; overflow:hidden; font-size:14px; margin-top:30px; margin-left:23px;"><div style="float:left; margin-top:2px;">选择您要推广的商城：</div>
        	    ...
        	    <asp:DropDownList ID="youmtype" runat="server" style="margin:-2px;"  AutoPostBack="true"
                        onselectedindexchanged="youmtype_SelectedIndexChanged"></asp:DropDownList>
                </div>
            ...
            <div style="height:22px; overflow:hidden; font-size:14px; margin-top:22px; margin-left:23px;">您的推广链接：
             ...
             <div style="background:#fff; margin:30px 16px 16px 16px;">
			    ...
			    <asp:RadioButtonList ID="rblShop" AutoPostBack="True" 
                     RepeatDirection="Horizontal" runat="server"  
                     onselectedindexchanged="rblShop_SelectedIndexChanged" ></asp:RadioButtonList>
