<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_Userunionprolink, App_Web_waugczbx" viewStateEncryptionMode="Never" %>
     ...
     <div id="container">
        <div style="background:#EAF5FE; margin-top:12px;">
            ...
            <asp:Button ID="btn" runat="server" style="vertical-align:top; margin-left:16px;" 
                    Text="生成推广链接" OnClientClick="return createprolink('prolink')" 
                    onclick="btn_Click"/>
        </div>
