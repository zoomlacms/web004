<%@ page language="C#" autoeventwireup="true" inherits="User_PrintServer_PrintServer, App_Web_bp2nz3fb" viewStateEncryptionMode="Never" %>
            ...
            <td valign="top">
                ...
                <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
                    <tbody id="Tabs0">
                        <tr class="tdbg">
                            <td align="center">
                                ...
                                <asp:HiddenField ID="hfMCid" runat="server" /><iframe id="Iframe1" style="top: 2px"
                                    src="/Common/UpLoadFlash.aspx?CID=Img&b=<%=bl %>" width="100%" height="25px"
                    ...
                    <tbody id="Tabs1" style="display: none">
                        <tr class="tdbg">
                            <td>
                                字体：<asp:DropDownList ID="ddlFontType" runat="server">
                                </asp:DropDownList>
                    ...
                    <tr>
                        <td>
                        <a href="javascript:void{}" onclick="ShowPrint()">预览</a>
                        </td>
                    </tr>
                </table>
                </form>
