<%@ page language="C#" autoeventwireup="true" inherits="User_Project_ProjectList, App_Web_rq5wffjg" viewStateEncryptionMode="Never" %>
...
您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span> &gt;&gt; </span><span><a title="用户项目列表" href="ProjectList.aspx">用户项目列表</a></span></span>
          </h1>
	  </div>
