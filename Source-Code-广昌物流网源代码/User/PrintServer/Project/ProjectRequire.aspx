<%@ page language="C#" autoeventwireup="true" inherits="User_Project_ProjectRequire, App_Web_rq5wffjg" viewStateEncryptionMode="Never" %>
...
<div class="s_bright">
	<div class="us_topinfo">
	  <div class="us_showinfo">
          ...
          您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span> &gt;&gt; </span><span><a title="提交服务" href="Project/ProjectList.aspx">提交服务</a></span></span>
          </h1>
	  </div>
