<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserBase, App_Web_51a3ncpo" viewStateEncryptionMode="Never" %>
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            ...
            <tr>
                <td style="width: 100%; line-height: 30px; text-align: center" colspan="4">
                    <asp:Button ID="btnSave" runat="server" Text="保存信息" Width="90px" OnClick="btnSave_Click"
                        TabIndex="12" />
                </td>
            </tr>
        </table>
