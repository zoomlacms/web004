<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_MtrlsMrktng, App_Web_3crn2uqv" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_topinfo" style="width: 98%">
        <div class="us_showinfo">
            <h1>
                您现在的位置：<span id="Span1"><span><a title="逐浪CMS" href="/" target="_blank"><asp:Label
                    ...
                    &gt;&gt; <span><a title="节日提醒" href="/User/Info/MtrlsMrktng.aspx">推广返利</a></span>
            </h1>
        </div>
        <div class="cleardiv">
        </div>
    ...
    <div class="tdbg" align="center">
        你的返利金额为:<asp:Label runat="server" ID="MoneyID" Text=""></asp:Label>
    </div>
    <div class="tdbg" align="center">
                    <span>                                                
