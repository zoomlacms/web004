<%@ page language="C#" autoeventwireup="true" inherits="User_Info_MyGetMoney, App_Web_3crn2uqv" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<body>
 <form id="form2" runat="server">
    <div>
     <div class="us_showinfo"><h1>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="MyGetMoney.aspx">我的收入</a></span>&nbsp;</span> </h1>
        </div>
    <div  id="nocontent" runat="server" >您目前还没有成功推荐好友注册!</div>
    <br />
    <div class="cleardiv"> </div>
        <div align="center"  runat="server" id="content">
         <div class="us_seta"  style="margin-top:5px;"><h1 align="center">我的收入</h1></div>
           <table width="100%">
               <tr>
                 ...
                 <tr align="left">
                    ...
                    &nbsp; &nbsp; &nbsp;<asp:Button ID="btnRe" runat="server" Text="转入我的资金" onclick="btnRe_Click" OnClientClick="return confirm('转入后所有记录归零,确定转入?')" /></div>
