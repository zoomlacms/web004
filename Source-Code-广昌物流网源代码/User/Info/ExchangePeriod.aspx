<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.ExchangePeriod, App_Web_3crn2uqv" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
     <div class="us_topinfo">
         ...
         <span class="us_showinfo1">您好<asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>！</span>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_blank">
                                会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>兑换有效期</span></span> </h1>
    </div></div>
    ...
    <div class="us_seta" style="margin-top:10px;" id="manageinfo" runat ="server">
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            ...
            <tr class="tdbg">
                ...
                <td style="width:80%;line-height:30px">
           		    &nbsp;有效期截止：<asp:Label ID="LblDeadLine" runat="server" Text=""></asp:Label> &nbsp;
           		    剩余天数：<asp:Label ID="LblDayCount" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr class="tdbg">
                <td style="width:20%; line-height:30px; text-align:right">
            ...
            <tr class="tdbg">
                ...
                <td style="width:80%;line-height:30px">
                    ...
                    <asp:TextBox ID="TxtBalance" runat="server" Width="20"></asp:TextBox>元兑换成有效期&nbsp;&nbsp;
                    ...
                    <asp:TextBox ID="TxtExp" runat="server" Width="20"></asp:TextBox>分兑换成有效期&nbsp;&nbsp;
