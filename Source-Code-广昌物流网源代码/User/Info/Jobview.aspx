<%@ page language="C#" autoeventwireup="true" inherits="User_Info_Jobview, App_Web_3crn2uqv" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div id="Div1" class="us_setaa2" style="margin-top:10px;" runat ="server">
       ...
       <li> <asp:Label ID="Label4" runat="server" Text=""></asp:Label></li>
        </ul>
    </div>
    ...
    <div class="us_seta" style="margin-top:10px;" id="manageinfo" runat ="server">
        <h1 style="text-align:center">信息列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label5" runat="server" 
                Text=""></asp:Label>
        </h1>
             <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="750px" 
