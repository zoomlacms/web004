<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.ExchangePoint, App_Web_3crn2uqv" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_topinfo">
         ...
         <span class="us_showinfo1">您好<asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>！</span>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_blank">
                                会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>兑换<asp:Literal ID="LitPointName" runat="server"></asp:Literal></span> </span></h1>
    </div></div>

    <div class="us_seta" style="margin-top:10px;" id="manageinfo" runat ="server">
        <h1 style="text-align:center">兑换<asp:Literal ID="LitPointName2" runat="server"></asp:Literal></h1>
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            ...
            <tr class="tdbg">
                ...
                <td style="width:80%;line-height:30px">
           		    &nbsp;
                    <asp:RadioButton ID="RblBalance" runat="server" GroupName="ExchgType" Checked="true" Text="使用资金余额：" />将
                    <asp:TextBox ID="TxtBalance" runat="server" Width="20"></asp:TextBox>元兑换成<asp:Literal ID="LitPointName4" runat="server"></asp:Literal>&nbsp;&nbsp;
                    兑换比率：<asp:Label ID="LblMoneyRate" runat="server" Text=""></asp:Label><br />
                    &nbsp;&nbsp;<asp:RadioButton ID="RblExp" runat="server" GroupName="ExchgType" Text="使用积分余额：" />将
                    <asp:TextBox ID="TxtExp" runat="server" Width="20"></asp:TextBox>分兑换成<asp:Literal ID="LitPointName5" runat="server"></asp:Literal>&nbsp;&nbsp;
