<%@ page language="C#" autoeventwireup="true" inherits="User_Shopfee_PaypalDefray, App_Web_nlgs1fga" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript">
    ...
    function submit() {
        ...
        //alert(document.getElementsByName("paypal").length());
        //document.getElementsByName("paypal").submit();
    }
