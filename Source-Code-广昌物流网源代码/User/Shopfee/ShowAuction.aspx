<%@ page language="C#" autoeventwireup="true" inherits="User_Shopfee_ShowAuction, App_Web_nlgs1fga" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                        ...
                        <ul style="width: 200px">
                            ...
                            <li style="float: left; width: 200px; height: 30px">竞拍类型：<asp:Label ID="lblTimer"
                                runat="server" Text="" ForeColor="Red"></asp:Label></li>
                                 <li style="float: left; width: 200px; height: 30px">竞拍结果：<asp:Label ID="Label2"
                                runat="server" Text="" ForeColor="Red"></asp:Label></li>
                        </ul>
                    </li>
            </ul>
