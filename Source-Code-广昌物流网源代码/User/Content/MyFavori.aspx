<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyFavori, App_Web_y3ifdjqg" viewStateEncryptionMode="Never" %>
...
您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx">会员中心</a></span><span> &gt;&gt; </span><span>内容收藏</span></span>
</div>
