<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_y3ifdjqg" viewStateEncryptionMode="Never" %>
...
<body>
    <div class="us_pynews" style="height: 24px; line-height: 24px; width:98%">
        您的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_top"><asp:Label
            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span> <span>&gt;&gt;
                ...
                &gt;&gt; </span><span>投稿管理</span></span> <span>&gt;&gt; </span><span>
                    <asp:Label ID="lblNodeName" runat="server" Text="Label"></asp:Label></span>
    </div>
