<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.User.Content.AddContentpage, App_Web_eawpwioj" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加内容</title>
...
<%Call.Label("{ZL.Label id=\"全部头部\"/}"); %>
<%Call.Label("{ZL.Label id=\"网站导航\"/}"); %>
