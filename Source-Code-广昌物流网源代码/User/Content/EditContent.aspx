<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.User.Content.EditContentpage, App_Web_y3ifdjqg" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_seta">
        <span><asp:Label ID="lblNodeName" runat="server" Text="Label"></asp:Label></span><span> &gt;&gt; </span><span>修改内容：<asp:Label ID="lblAddContent" runat="server" Text="Label"></asp:Label></span>
		  ...
		  <ul class="us_seta" style="margin-top:10px;">
              ...
              <li style="width:120px; float:left;line-height:30px">
        ...
        <li id="bidmoneytable" style="width: 120px; float: left; line-height: 30px; text-align: right;">
