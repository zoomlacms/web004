<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_PointRecord, App_Web_f1ayougd" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_topinfo">
        ...
        </span> &gt;&gt; <span><a href="PointRecord.aspx">我的积分</a></span></span> </h1>
        </div>
         <div class="cleardiv"> </div>
        </div>
        <div class="us_seta"  style="margin-top:5px;"><h1 align="center">我的积分</h1></div>
        <div><asp:Literal ID="liPoint" runat="server"></asp:Literal></div>
        <div align="center">
           <table width="100%">
               <tr>
                 ...
                 <table> <tr class="tdbg">
                <td height="24" colspan="3" align="center" class="tdbgleft">
