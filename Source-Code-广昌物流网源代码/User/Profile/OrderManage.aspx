<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_OrderManage, App_Web_f1ayougd" viewStateEncryptionMode="Never" %>
    ...
    <h1>
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span>&gt;&gt;
                    ...
                    会员中心</a></span><span> &gt;&gt; </span><span><a title="我的订单" href="OrderManage.aspx?state=0">
                        我的订单</a></span></span>
        </h1>
    </div>
    <div class="cleardiv">
...
<div class="us_topinfo" style="margin-top: 10px; width: 98%; margin-left: 10px">
    <a href="OrderManage.aspx?state=0">待返订单</a> | <a href="OrderManage.aspx?state=1">已返订单</a>
    | <a href="OrderManage.aspx?state=2">失效订单</a></div>
<div style="margin-left: 10px; ">
   <div id="orderlist" runat="server" style="float:left;margin-top:5px"></div>
    <div id="order" runat="server" style="margin-left: 15px;margin-top:5px;float:right">
        如果您刚下的单不在列表中，<a id="look" href="javascript:void(0)" onclick="Show()">点此查看↓</a>  </div>
        <br /><div id="hedui" style="display:none;">
            <ul class="item_list">
                <li><strong>请核对您的下单时间：</strong></li>
                <li style="color:Gray">如果不到30分钟，请耐心等待，30分钟后<a href="?state=0">点此刷新</a></li>
                <li style="color:Gray">如果超过30分钟，建议您去商家页面取消订单后重新下单；或者将您的订单编号、下单时间提交给在线客服，我们会在24小时内帮您核对。
                <a href="###">提交给在线客服&gt;&gt;</a></li>
            </ul>
        </div>
...
<div>
   ...
   <br /> <div id="tips" runat="server" style="background:#FEEADB;padding:5px;margin-left:5px;"> </div>
    <div align="center">
        <table width="100%">
            <tr>
