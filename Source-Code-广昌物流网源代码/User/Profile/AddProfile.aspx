<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_AddProfile, App_Web_f1ayougd" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_showinfo">
        <h1>
            您现在的位置：<span id="Span1"><a title="网站首页" href="/" target="_blank"><asp:Label
                ID="LblSiteName" runat="server" Text=""></asp:Label></a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a>
                    &gt;&gt; <a href="OrderManage.aspx?state=0">我的订单</a></span> &gt;&gt;<a>用户提交订单</a></h1>
    </div>
    <div class="cleardiv">
    </div>
</div>
