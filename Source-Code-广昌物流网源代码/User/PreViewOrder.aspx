<%@ page language="C#" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_1f4rxn1h" viewStateEncryptionMode="Never" %>
                ...
                <h1>
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                            ...
                            &gt;&gt; </span><span><a title="购物订单管理" href="OrderForm/ShopCarList.aspx?menu=Cartinfo">
                                购物订单管理</a></span></span>
                </h1>
            </div>
            <div class="cleardiv">
        ...
        <div class="us_topinfo" style="margin-top: 10px;">
            <a href="PreViewOrder.aspx?menu=Cartinfo">购物车管理</a> <a href="PreViewOrder.aspx?menu=Orderinfo">
                订单管理</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=1">已确定的订单</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=2">
                    已发货订单</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=3">正常订单</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=4">
                        已成交订单</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=5">已作废订单</a>
            <a href="PreViewOrder.aspx?menu=Orderinfo&type=0">代购订单</a> <a href="PreViewOrder.aspx?menu=Orderinfo&type=1&panel=1">
                代购历史订单</a> <a href="Shopfee/MyAuctionList.aspx">竞拍记录</a> <a href="HotelOrder.aspx?menu=Cartinfo">酒店订单</a>
                <a href="FeightOrder.aspx?menu=Cartinfo">机票订单</a> <a href="TripOrder.aspx?menu=Cartinfo">旅游订单</a>
                <span style="float:right">
                 <input ID="Button11" runat="server"
                            onclick="location.href='/user/iServer/FiServer.aspx?menu=OrderType'" 
                            type="button" value="服务记录" />
                 </span>
        </div>
                ...
                <asp:Repeater ID="Ordertable" runat="server">
                    <ItemTemplate>
                        <ul>
                            ...
                            <li style="width: 8%; float: left; line-height: 28px; text-align: center; text-overflow: ellipsis;white-space: nowrap; overflow: hidden">
                                <%#Eval("AddTime") %> </li>
                    ...
                    <ItemTemplate>
                        <ul>
                            <li id="1" style="width: 19.9%; float: left; line-height: 28px; text-align: left;
                                text-overflow: ellipsis; white-space: nowrap; overflow: hidden"><a href="?menu=ViewOrderlist&tp=Pre&id=<%#Eval("id") %>&">
                                    <%#Eval("OrderNo")%></a> </li>
                            <li style="width: 10%; float: left; line-height: 28px; text-align: center;">
                                <%#Eval("Reuser") %>
                            </li>
                ...
                <ul>
                    <li style="width: 98.5%; float: left; line-height: 28px; text-align: left;">共
                        ...
                        页次：<asp:Label ID="Label7" runat="server" Text="" />/<asp:Label ID="Label8" runat="server"
                            Text="" />页
                       <asp:TextBox ID="txtpages" runat="server" Width="25px" AutoPostBack="True" 
                            ontextchanged="txtpages_TextChanged"></asp:TextBox>
                        条记录/页 转到第
            ...
            <asp:Panel ID="Panel2" runat="server" Width="100%" Visible="false">
                    ...
                    <ItemTemplate>
                        <ul>
                            <li style="width: 24.6%; float: left; line-height: 30px; text-align: center; text-overflow: ellipsis;
                                white-space: nowrap; overflow: hidden"><a href='../shop.aspx?ItemID=<%#Eval("ProID") %>'
                                    target='_blank'>
                ...
                <ul>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        合计：<asp:Label ID="preojiage" runat="server" Text=""></asp:Label>
                        元 </li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        运费：<asp:Label ID="preoyunfei" runat="server" Text=""></asp:Label>
                        元 </li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        实际金额：<asp:Label ID="preojiages" runat="server" Text=""></asp:Label>
                        +
                        <asp:Label ID="precyunfei" runat="server" Text=""></asp:Label>＝<asp:Label ID="preorderallpromoney"
                            runat="server" Text=""></asp:Label>
                        元 </li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        已付款：<asp:Label ID="prelabelmoney" runat="server" Text=""></asp:Label>
                        元 </li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        快递单号：<asp:Label ID="Label10" runat="server" Text=""></asp:Label></li>
                </ul>
                <ul>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: center;">
                        <asp:Button ID="Button3" OnClientClick="javascript:history.go(-1);return false;"
                            runat="server" Text="返回" />
&nbsp;
                        <asp:Button ID="Button6" runat="server" Text="支付提交"  OnClientClick="return confirm('确定支付?')"
...
&nbsp;
                        ...
                        &nbsp;
                       <input ID="Button10" 
                            onclick="location.href='/user/iServer/FiServer.aspx?OrderID=<%=sid %>';" 
                            type="button" value="提交问题" />
                        </li>
                </ul>
            </asp:Panel>
                ...
                <ul>
                    <li style="width: 98.5%; float: left; line-height: 28px; text-align: left;">共
                        ...
                        页次：<asp:Label ID="Nowpage1" runat="server" Text="" />/<asp:Label ID="PageSize1" runat="server"
                            Text="" />页
                        <asp:TextBox ID="txtpage2" runat="server" Width="25px" AutoPostBack="True" 
                            ontextchanged="txtpage2_TextChanged"></asp:TextBox>
                        条记录/页 转到第
                ...
                <asp:Repeater ID="cartproinfo" runat="server">
                    <ItemTemplate>
                        <ul>
                            ...
                            <li style="width: 16.6%; float: left; line-height: 24px; text-align: center"><a href="?menu=delcartpro&id=<%#Eval("id") %>"
            ...
            <asp:Panel ID="OrderProlist" runat="server" Width="100%" Visible="false">
                ...
                <ul>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        合计：<asp:Label ID="ojiage01" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        运费：<asp:Label ID="oyunfei01" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        包装费：<asp:Label ID="lblpack" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        实际金额：<asp:Label ID="ojiages01" runat="server" Text=""></asp:Label>
                        +<asp:Label ID="cyunfei01" runat="server" Text=""></asp:Label>
                        +<asp:Label ID="pack01" runat="server" Text=""></asp:Label>＝<asp:Label ID="orderallpromoney01" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        已付款：<asp:Label ID="labelmoney01" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        快递单号：<asp:Label ID="label9" runat="server" Text=""></asp:Label></li>
                </ul>
                ...
                <ul>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        合计：<asp:Label ID="ojiage" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        运费：<asp:Label ID="oyunfei" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        实际金额：<asp:Label ID="ojiages" runat="server" Text=""></asp:Label>
                        +
                        <asp:Label ID="cyunfei" runat="server" Text=""></asp:Label>＝<asp:Label ID="orderallpromoney" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        已付款：<asp:Label ID="labelmoney" runat="server" Text=""></asp:Label></li>
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                        快递单号：<asp:Label ID="label11" runat="server" Text=""></asp:Label></li>
                </ul>
...
&nbsp;
                        <asp:Button ID="btnANewBuy" runat="server" OnClick="btnANewBuy_Click" 
                            Text="重新购买" Visible="false" />
                        <input ID="Button4" 
                            onclick="window.open('PreViewOrder.aspx?menu=rebuy&amp;id=<%=sid %>');" 
                            type="button" value="重新购买" />
                            &nbsp;
                       <input ID="Button9" 
                            onclick="location.href='/user/iServer/FiServer.aspx?OrderID=<%=sid %>'" 
                            type="button" value="提交问题" />
