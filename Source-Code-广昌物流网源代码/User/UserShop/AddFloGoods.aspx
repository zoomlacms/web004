<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_AddFloGoods, App_Web_kp4osgt1" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑运货方式</title>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;"
        ...
        <tr>
            ...
            <td width="67%">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator8"  runat="server" ControlToValidate="txtPrice" ErrorMessage="运费格式不正确!"
