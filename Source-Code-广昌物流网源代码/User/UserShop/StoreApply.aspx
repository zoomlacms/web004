<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_StoreApply, App_Web_pfpa340c" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <ul class="us_seta" style="margin-top: 10px;" id="add" runat="server">
        ...
        <li style="width: 120px; float: left; text-align: right">商铺类型： </li>
        <li style="width: 70%;">&nbsp;<asp:DropDownList ID="DropDownList1" runat="server"
