<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_DeliverUserManage, App_Web_kp4osgt1" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>送货员管理</title>
...
您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
    ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
        ...
        <span> &gt;&gt; </span><span><a title="送货员管理" href="DeliverUserManage.aspx">送货员管理</a></span></span></h1></div>
</div>
