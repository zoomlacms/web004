<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_Addclass, App_Web_pfpa340c" viewStateEncryptionMode="Never" %>
                ...
                <tr>
                    ...
                    <td width="67%">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ErrorMessage="排列顺序不能为空！" ControlToValidate="Orderid" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" 
                            ErrorMessage="排列顺序格式不正确！" ControlToValidate="Orderid" 
                            MaximumValue="99999999" MinimumValue="0" Display="Dynamic"></asp:RangeValidator>数字越大排列越前
                    </td>
                </tr>
