<%@ page language="C#" autoeventwireup="true" inherits="User_PrintServer_FeightOrder, App_Web_aovcpxcb" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
        <div class="us_topinfo">
            <div class="us_showinfo">
                <h1>
                    您现在的位置：<span id="YourPosition"><a title="网站首页" href="/" target="_blank"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;
