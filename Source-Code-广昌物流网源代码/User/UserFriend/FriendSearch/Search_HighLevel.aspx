<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_FriendSearch_Search_HighLevel, App_Web_ub0nx0rr" viewStateEncryptionMode="Never" %>
...
<%@ Register Src="~/User/UserFriend/WebUserControlTop.ascx" TagName="WebUserControlTop"
TagPrefix="uc1" %>
<!DOCTYPE HTML>
<html>
...
<div style="margin: auto; width: 100%">
        <div class="us_topinfo">
            ...
            您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                ...
                <span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span>
...
<asp:Panel ID="quickresultPanel" runat="server" Width="100%">
   <ul class="lieb" style=" width:100%;">
    <asp:DataList ID="DataList1" runat="server" Width="100%" RepeatColumns="4" 
          ...
          <ItemTemplate>                     
   <li class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style=" float:left;width:120px;">
    ...
    <br />
    <%# Eval("honeyname" )%> <br />
 <%#GetWorkProvince(Eval("workprovince").ToString()) %> <%#GetWorkCity(Eval("workcity").ToString()) %>
    <a href="../../../Zone/ShowList.aspx?id=<%#Eval("UserID") %>">详细了解</a>
                  
                        <%--<a href="../../../ShowList.aspx?id=<%#DataBinder.Eval(Container.DataItem,"UserID") %>">
                            <asp:Image ID="Image1" runat="server" Height="120px" Width="100px" ImageUrl='<%#DataBinder.Eval(Container.DataItem,"userface") %>' /></a>                            
                        昵称： <a href="#"><%#DataBinder.Eval(Container.DataItem,"honeyName") %></a><br />
                        个人独白： &nbsp;<%#DataBinder.Eval(Container.DataItem, "UserLove")%>
                        </div>
            </li>  
        
</ItemTemplate>
    </asp:DataList>
    总共<asp:Label ID="Count" runat="server" ></asp:Label>记录 &nbsp;
