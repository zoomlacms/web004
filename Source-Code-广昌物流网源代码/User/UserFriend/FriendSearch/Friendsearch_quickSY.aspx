<%@ page language="C#" autoeventwireup="true" inherits="Friendsearch_quickSY, App_Web_se42woc4" enableeventvalidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table border="0" class="us_showinfo" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td width="69%" align="left">
                    <input id="radioSex1" type="radio" value="男生" name="sex" checked="checked" />男生<input
                        id="radioSex2" type="radio" name="sex" value="女生" />
                女生
            </tr>
            <tr>
                <td align="right">
                ...
                <td align="left">
                    &nbsp;<input id="txtAge1" type="text" style="width: 48px" onkeyup="value=value.replace(/[^\d\.]/g,'')" />~<input
                        id="txtAge2" type="text" style="width: 48px" onkeyup="value=value.replace(/[^\d\.]/g,'')" />
                </td>
            </tr>
            <tr>
                <td align="right">
