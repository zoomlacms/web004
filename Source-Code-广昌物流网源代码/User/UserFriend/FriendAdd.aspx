<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_FriendAdd, App_Web_itzbtvut" viewStateEncryptionMode="Never" %>
...
<div class="s_bright">
	...
	<div class="us_topinfo">
	  <div class="us_showinfo">
		  <h1>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a></span><span> &gt;&gt; </span><span><a title="我的好友" href="/User/UserFriend/Index.aspx">我的好友</a></span></span>&gt;&gt;好友管理
          </h1>
	  </div>  
    ...
    <li style="width:120px; float:left;line-height:30px; text-align:right;">用户ID：
              </li>
               <li style="width:70%;line-height:30px"><asp:TextBox ID="Nametxt" runat="server" Text='' Width="35%" MaxLength="30"></asp:TextBox>
                    <span><font color="red">*</font></span>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                        runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="Nametxt">名称必填</asp:RequiredFieldValidator></li>
                          <li style="width:120px; float:left;line-height:30px; text-align:right;">选择分组：
              </li>
               <li style="width:70%;line-height:30px"><asp:DropDownList ID="DropDownList1" runat="server">
        </asp:DropDownList></li>
        <li >
