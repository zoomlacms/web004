<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_FriendGroup, App_Web_qhavlahz" viewStateEncryptionMode="Never" %>
...
<%@ Register Src="../UserFriend/WebUserControlTop.ascx" TagName="WebUserControlTop"
    TagPrefix="uc3" %>
<!DOCTYPE HTML>
<html>
                    ...
                    <tr class="tdbg">
                        <td height="24" colspan="12" align="center" class="tdbgleft">
                            ...
                            页次：<asp:Label ID="Nowpage" runat="server" Text="" />/<asp:Label ID="PageSize" runat="server"
                                Text="" />页
                            <asp:Label ID="pagess" runat="server" Text="" />/页 转到第<asp:DropDownList ID="DropDownList1"
