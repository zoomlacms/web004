<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_AddPub, App_Web_orbb5nmy" viewStateEncryptionMode="Never" %>
     ...
     <div class="us_seta" style="margin-top:10px;" id="manageinfo" runat ="server">
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            <tr class="tdbg">
             ...
             <tr class="tdbg">
<td align="right" class="style1">标题</td><td><asp:TextBox ID="TextBox1" runat="server" 
                     Width="365px"></asp:TextBox></td></tr>
  <tr class="tdbg">
