<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_ViewSmallPub, App_Web_orbb5nmy" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="clearbox">
      ...
      <asp:Button ID="Button3" runat="server"  OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"
                        Text="批量删除" onclick="Button3_Click"  Visible="false" />
    </form>
</body>
</html>
