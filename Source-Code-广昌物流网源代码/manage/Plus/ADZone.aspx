<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZone, App_Web_utzfqbad" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
       ...
       <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; 
           <a href="ADZoneManage.aspx" title="广告版位管理">版位管理</a> &gt;&gt; <span>添加广告版位</span></div> 
        ...
        <table border="0" cellpadding="2" cellspacing="1" class="border" width="100%">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td align="left"  style="color: red; width: 650px; height: 24px;">
            ...
            <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left" class="tdbgleft" style="height: 46px">
                    ...
                    选择放置于此版位的广告类型。</td>
                <td   style="height: 46px; width: 650px;">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left" class="tdbgleft">
                    ...
                    设为活动的版位才能在前台显示。</td>
                <td style="height: 49px; width: 650px;">
