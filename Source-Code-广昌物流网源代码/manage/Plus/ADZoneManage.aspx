<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZoneManage, App_Web_utzfqbad" viewStateEncryptionMode="Never" %>
...
<body onload="pload()">
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="ADZoneManage.aspx">广告管理</a></span> &gt;&gt; 版位管理
    </div>
    <div class="clearbox">
    </div>
    <div class="line">
        根据版位名搜索：<asp:TextBox ID="TxtADName" runat="server" class="l_input">关键字</asp:TextBox><asp:Button
            ID="BntSearch" runat="server" Text="查询" OnClick="BntSearch_Click" class="C_input" /></div>
    <div>
        <div class="clearbox">
        </div>
