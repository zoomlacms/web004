<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.ADManage, App_Web_utzfqbad" viewStateEncryptionMode="Never" %>
...
<body onload="pload()">
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="ADManage.aspx">广告管理</a></span>&gt;&gt;<span>广告列表</span>
    </div>
    <div class="clearbox">
    </div> 
    <div>
