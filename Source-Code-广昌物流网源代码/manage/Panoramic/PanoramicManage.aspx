<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_PanoramicManage, App_Web_vzrlfzxl" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="PanoramicManage.aspx">全景管理</a></span> <span>[<a href="AddPanoramic.aspx">添加全景</a>]</span>
	</div>
	<br />
	<div class="r_navigation">
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td colspan="5" class="spacingtitle" align="center">全景管理
				</td>
			</tr>
			<tr class="tdbgleft">
			...
			<asp:Repeater ID="Repeater1" runat="server">
				<ItemTemplate>
					<tr class="tdbg" height="25px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td align="center">
							<a href="AddPanoramic.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a> <a href="javascript:void(0);" onclick="Open_Select(<%#Eval("ID") %>)">预览</a> <a href="?menu=delete&id=<%#Eval("ID") %>" onclick="return confirm('确实要删除吗？删除后该信息无法恢复!')">删除</a>
						</td>
					</tr>
				</ItemTemplate>
			</asp:Repeater>
