<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_hrpakhkf" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;" id="TABLE1">
        ...
        <tr class="tdbg">
        <td colspan="4">
            快递单号：<asp:TextBox ID="txtMS" runat="server" class="l_input"></asp:TextBox>
			...
			<asp:Button ID="btnfahuo" runat="server" OnClick="Button3_Click" Text="发货" class="C_input"></asp:Button></td>
        </tr>
        </tbody>
