<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_MtrlsMrktng, App_Web_hrpakhkf" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="tdbg" align="center">
        你的返利余额为:<asp:Label runat="server" ID="MoneyID" Text=""></asp:Label>
    </div>
    <div class="tdbg" align="center">
                    <span>                                                
