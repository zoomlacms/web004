<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_hrpakhkf" viewStateEncryptionMode="Never" %>
                                        ...
                                        <asp:View ID="View1" runat="server">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="ColonelStartTimetxt" runat="server" OnFocus="setday(this)" class="l_input"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        结束时间:
                                                    </td>
