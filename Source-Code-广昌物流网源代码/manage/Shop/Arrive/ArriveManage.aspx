<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Arrive_ArriveManage, App_Web_j5y0djcy" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>优惠劵管理</title>
    ...
    <asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="False" class="border"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="生成时间" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                <ItemTemplate>
                    <asp:Label ID="lblAginTime" runat="server" Text='<%# Eval("AgainTime") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
