<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.login, App_Web_rqtvmsdf" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>管理登陆</title>
...
<div id="main">
    <div id="login">
        <ul>
            <li><span>用户名
                <asp:TextBox ID="TxtUserName" runat="server" CssClass="username" TabIndex="1"  autocomplete="off" ></asp:TextBox></span></li>
            <li><span>密 &nbsp;码
                <asp:TextBox ID="TxtPassword" TextMode="Password" runat="server" MaxLength="18" CssClass="password" TabIndex="2"  autocomplete="off" ></asp:TextBox></span></li>
            <li id="safecode" runat="server"><span>安全码
                <asp:TextBox ID="TxtAdminValidateCode" TextMode="Password" runat="server" MaxLength="6" CssClass="Safeword" TabIndex="3"></asp:TextBox></span>
            </li>
            <li><span>验证码
                ...
                <asp:TextBox ID="TxtValidateCode" runat="server" CssClass="vercode" Style="width: 52px;"    TabIndex="4" autocomplete="off" ></asp:TextBox></span></li>
            <li style="width:100%">
...
<div id="copyright">Copytight (C) Shanghai Zoomla!CMS Software technology Co., LTD all rights reserved</div>
</form>
</body>
</html>