<%@ page language="C#" autoeventwireup="true" inherits="manage_SystemCheck_, App_Web_rqtvmsdf" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>浏览器检测</title>
...
<div><br /><a href="http://bbs.zoomla.cn/showtopic-3491.aspx" title="帮助提示" style="color:#1370b5;text-decoration:none;" target="_blank" >《如何设置cookie》</a>&nbsp;&nbsp;&nbsp;
<a href="http://bbs.zoomla.cn/showtopic-3490.aspx" title="帮助提示" style="color:#1370b5;text-decoration:none;" target="_blank">《如何设置网页脚本》</a></div>
</div>
