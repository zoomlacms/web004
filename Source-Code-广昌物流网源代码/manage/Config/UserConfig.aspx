<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_fi1obr2j" validaterequest="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0">
            <tr align="center">
                ...
                <td id="TabTitle4" class="tabtitle" onclick="show1(4)">
                    IP限制
                </td>
            </tr>
        </table>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border">
        <tbody id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
             ...
             <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td style="width: 500px">
                    <asp:TextBox ID="txtGetPassword" runat="server" Rows="6" TextMode="MultiLine" Width="300px"  class="x_input"></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <tbody id="Tabs1" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                ...
                <td>
                    <asp:TextBox ID="TxtPresentExp" Text="0" runat="server" Columns="7" MaxLength="7" class="l_input" />分积分
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                ...
                <td>
                    <asp:TextBox ID="TxtPresentMoney" Text="0" runat="server" Columns="7" MaxLength="7" class="l_input" />元钱
        ...
        <tbody id="Tabs2" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" style="display:none" onmouseout="this.className='tdbg'" id="Tr7">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" visible="false" onmouseout="this.className='tdbg'" runat="server" id="Tr6">
                <td class="tdbgleft">
