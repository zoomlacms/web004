<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_CitizenXmlConfig, App_Web_fi1obr2j" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>附件管理</span> &gt;&gt;<a href="GradeCateManage.aspx">多级数据字典分类:</a><span
            style="color: Red"><asp:Label ID="lblCateName" runat="server" Text=""></asp:Label></span>&gt;&gt;<span><asp:Label
                ID="LblGradeLevel" runat="server" Text=""></asp:Label>选项列表</span>
    </div>
    <div class="clearbox">
    </div>
