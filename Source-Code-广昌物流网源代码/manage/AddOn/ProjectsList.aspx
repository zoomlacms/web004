<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectsList, App_Web_xojnnf2n" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>项目列表</title>
    ...
    <div class="us_showinfo">
        <h1>
            <span class="us_showinfo1">您好<asp:Label ID="lblUserName" runat="server" Text="Label"></asp:Label>！</span>您现在的位置：<span
                id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心"
                href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_blank">会员中心</a></span>&gt;&gt; <span><a href="/User/Skin/UserInfo.aspx">常规管理</a></span><span> &gt;&gt; </span><span>查看项目</span>
            </span>
        </h1>
    </div>
    <div class="clearbox"></div>
    <div class="us_seta" style="margin-top:5px;"><h1 align="center"><asp:Label ID="LblTitle" runat="server" Text="查看项目"></asp:Label></h1></div>
    <div style="width:100%">
        ...
        <div style="float:left">
           <a href="ProjectsList.aspx">列表显示</a>
           <a href="ProjectsView.aspx">标签显示</a>
        </div>
        <div style="float:right">根据项目名称查询项目：<asp:TextBox ID="TxtSearch" runat="server" class="l_input"></asp:TextBox>
            ...
            <asp:Repeater ID="Repeater1" runat="server" onitemcommand="Repeater1_ItemCommand">
                <ItemTemplate>
                    <tr height="30px" class="us_menu" align="center" style="background-color:#DEDFDE">
                        ...
                        <td>
                            <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("ID")%>' CommandName="manage">查看编辑</asp:LinkButton>&nbsp;|
                            ...
                            <asp:LinkButton ID="LbtnComments" runat="server" CommandArgument='<%# Eval("ID")%>' CommandName="Comments" Enabled='<%#GetBool(Eval("ProStatus","{0}")) %>'>评论</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
