<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_FileseeManage, App_Web_xojnnf2n" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg">
           ...
           　　文件比较功能是ZoomLa!逐浪CMS为了防止木马和一些不法分子使用服务器漏洞上传非法文件的有效手段，可以让您使用此功能扫描该文件是否和官方文件是否相同，如果经过了更改；文件名颜色标识为红色，否者为绿色！并且有中文提示!<br />
