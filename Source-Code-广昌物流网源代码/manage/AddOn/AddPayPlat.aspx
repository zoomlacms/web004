<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.AddPayPlat, App_Web_xojnnf2n" viewStateEncryptionMode="Never" %>
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft">
            <strong>备注：</strong></td>
        <td>
            <asp:TextBox ID="txtRemark" runat="server" Text="" class="l_input" 
                TextMode="MultiLine" Height="144px" Width="509px"/>
        </td>            
    </tr> 
</table>
