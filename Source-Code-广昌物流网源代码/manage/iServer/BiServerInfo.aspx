<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BiServerInfo, App_Web_isspl3pb" validaterequest="false" viewStateEncryptionMode="Never" %>
...
<span>后台管理</span>&gt;&gt;<span><a href="BiServer.aspx">有问必答</a></span>&gt;&gt;<span>问题详情</span>
    ...
    <form id="frm_supportticket" runat="server">
		...
		<table width="100%" class="border" cellspacing="0" cellpadding="0" style="margin-top:10px;">
			<tr>
		...
		<table width="100%" class="border" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
		    <tr>
		 ...
		 <asp:Repeater ID="resultsRepeater" runat="server">
                <HeaderTemplate>
                    <table width="100%" cellpadding="4" class="border" cellspacing="0" style="margin-top:10px;">
                    <tr>
		...
		<input type="checkbox" id="email_answer" name="email_answer" runat="server"/>发送E-mail回复给：<input  type="text" runat="server" id="UserEmail" name="reply_to" value="" />
