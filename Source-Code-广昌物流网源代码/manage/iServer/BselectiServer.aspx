<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BselectiServer, App_Web_isspl3pb" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>有问必答</title>
    ...
    <asp:Repeater ID="resultsRepeater_w" runat="server">
        ...
        <ItemTemplate>
            <tr align="center" class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td><a href="BiServerInfo.aspx?QuestionId=<%#Eval("QuestionId")%>">
                ...
                <td><a href="BiServerInfo.aspx?QuestionId=<%#Eval("QuestionId")%>" >编辑</a> &nbsp;&nbsp;
