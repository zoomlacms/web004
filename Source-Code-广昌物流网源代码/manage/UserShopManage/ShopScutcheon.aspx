<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ShopScutcheon, App_Web_tkmlrnn4" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 店铺设置 &gt;&gt; <span><a href="TrademarkManage.aspx">品牌管理</a></span>	<a href="AddShopBrand.aspx">[添加品牌]</a></div>
    ...
    <td width="51" align="center" class="title">
      ...
      <td width="304" align="center" class="title">
          ...
          <td height="24" align="center">&nbsp; <a href="Trademark.aspx?menu=edit&id=<%#Eval("id") %>">修改</a> <%#showstop(DataBinder.Eval(Container, "DataItem.id", "{0}"))%> <%#showtop(DataBinder.Eval(Container, "DataItem.id", "{0}"))%> <%#showjian(DataBinder.Eval(Container, "DataItem.id", "{0}"))%> <a href="?menu=delete&id=<%#Eval("id") %>" OnClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</a></td>
        </tr>  
          </ItemTemplate>
          </asp:Repeater>
        ...
        <tr>
          <td height="24" colspan="12"><asp:Button ID="Button1" class="C_input"  style="width:110px;"  Text="删除选中品牌" runat="server" OnClick="Button1_Click" /></td>
        </tr>
      </tbody>
    </table>
</form>
