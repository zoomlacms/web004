<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ApplyStyleEdit, App_Web_tkmlrnn4" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="RepModelField" runat="server" OnItemCommand="Repeater1_ItemCommand">
                <ItemTemplate>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td align="center"><a href="EditField.aspx?FieldID=<%# Eval("FieldID") %>">修改</a> | 
