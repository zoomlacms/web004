<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Template.TemplateList, App_Web_kjsxri35" viewStateEncryptionMode="Never" %>
            ...
            <table style="width: 100%; height: 100%" border="0" cellpadding="2" cellspacing="0"
                ...
                <tr style="height: 100%; width: 100%">                    
                    <td class="tdbg" align="left" valign="top" colspan="3" style="width: 70%;">
                     ...
                     <iframe id="main_right" name="main_right" scrolling="yes" style="width: 100%;height:160px;" src="SelectTemplate.aspx" frameborder="0" marginheight="0" marginwidth="1"></iframe>
                    </td>
                </tr>
