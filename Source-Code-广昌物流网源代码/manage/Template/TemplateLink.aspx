<%@ page language="C#" autoeventwireup="true" inherits="manage_Template_TemplateLink, App_Web_kjsxri35" viewStateEncryptionMode="Never" %>
        ...
        <li id="Guide_main">
            <div id="Guide_box">
                ...
                <ul>                        
                    ...
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="javascript:gotourl('Template/LabelExport.aspx');">标签升级</a></li>
                </ul>
                </div>
            </div>
        </li>
