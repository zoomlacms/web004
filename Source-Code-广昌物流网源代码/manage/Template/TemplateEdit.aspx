<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateEdit, App_Web_kjsxri35" viewStateEncryptionMode="Never" %>
        ...
        <table width="100%" cellpadding="2" border="0" cellspacing="1" class="border" align="center">
            <tr class="title">
                <td align="left" colspan="2">
                    编辑模板 文件名：
                    <asp:TextBox ID="TxtFilename" class="l_input" runat="server"></asp:TextBox>
