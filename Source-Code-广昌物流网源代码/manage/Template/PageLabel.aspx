<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Template.PageLabel, App_Web_ve1y1w5a" viewStateEncryptionMode="Never" %>
<html>
<head runat="server">
<title>分页标签编辑</title>
