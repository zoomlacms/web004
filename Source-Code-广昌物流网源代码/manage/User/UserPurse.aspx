<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserPurse, App_Web_wpkjuyyn" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border"> 
    ...
    <tr class="tdbg">
        <td class="tdbgleft" style="width: 20%" align="right">                    
            会员名：</td>
        <td class="bqright">
      <asp:LinkButton ID="lbUserName" runat="server" PostBackUrl='~/manage/User/Usreinfo.aspx?id=<%=Request.QueryString("UserID") %>'></asp:LinkButton></td>
     </tr>
     <tr class="tdbg">
        <td class="tdbgleft" style="width: 20%" align="right">                    
            资金余额：</td>
