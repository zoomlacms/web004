<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.AddRole, App_Web_wpkjuyyn" title="添加角色" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border" align="center">        
        ...
        <asp:Button ID="btnSave"
            runat="server" Text="保存角色" Width="95px" OnClick="Button2_Click" class="C_input"   />
        &nbsp; &nbsp; &nbsp;&nbsp;
