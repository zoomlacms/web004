<%@ page language="C#" autoeventwireup="true" inherits="manage_User_InputUser, App_Web_cm3xdgcb" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
            ...
            <tr class="tdbg">
                ...
                <td align="left" class="style3" colspan="3">
                    <asp:TextBox ID="userpwd" TextMode="Password" CssClass="l_input" 
                        runat="server" Width="172px"></asp:TextBox> 默认为:123
                </td>
            </tr>
        </table>
