<%@ page language="C#" title="角色管理" autoeventwireup="true" inherits="User.RoleManage, App_Web_cm3xdgcb" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span><a href="AdminManage.aspx">管理员管理</a></span> &gt;&gt;角色管理&nbsp;&nbsp;<a
            href="AddRole.aspx">[添加角色]</a>
    </div>
    <div class="clearbox">
    </div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LnkDel" CommandName="Del" Enabled='<%# Returnuser(Eval("RoleID").ToString()) %>'
                        CommandArgument='<%# Eval("RoleID")%>' runat="server">删除</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton1" Enabled='<%# Returnuser(Eval("RoleID").ToString()) %>'
                        CommandName="ModifyPower" CommandArgument='<%# Eval("RoleID")%>' runat="server">权限设置</asp:LinkButton>
                </ItemTemplate>
                <ItemStyle  HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
