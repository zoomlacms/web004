<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddNodecs, App_Web_0i4cscq5" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                                        ...
                                        <ItemTemplate>
                                            <tr class="tdbg">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="button" value="选择模板" class="C_input"  style="width:100px;"  onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TxtModelTemplate_<%# Eval("ModelID") %>')+'&FilesDir=',650,480)"
                                                         />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
