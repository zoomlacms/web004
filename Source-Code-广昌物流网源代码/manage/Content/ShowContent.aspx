<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ShowContent, App_Web_f3maib1t" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
	...
	<tr class="tdbg">
		<td valign="top" style="margin-top: 0px; margin-left: 0px;">
			<table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
				...
				<tbody id="Tabs0">
					<tr class="tdbg">
						<td style="width: 13%" class="tdbgleft" align="center">
							<strong>所属节点</strong>
						</td>
						<td>
					...
					<tr class="tdbg">
						<td colspan="2">
							<asp:DetailsView ID="DetailsView1" runat="server" Width="100%" CellPadding="4" GridLines="None"
								Font-Size="12px" Style="margin-bottom: 0px; margin-top: 0px;" 
				...
				<tbody id="Tabs1" style="display: none">
					<tr class="tdbg">
						<td style="width: 130px" class="tdbgleft" align="center">
							<strong>录入者：</strong>
						</td>
						<td>
