<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.CollectionStep1, App_Web_0i4cscq5" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:DropDownList ID="ddlModel" runat="server" DataTextField="ModelName" DataValueField="ModelID">
                </asp:DropDownList>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="txtNode" runat="server" Width="250px" Enabled="false" Text="内容中心" class="l_input"></asp:TextBox>&nbsp;<input id="Button2" class="C_input"  style="width:130px;"  type="button" value="更改节点" style="width: 80px" onclick="AddNode('link')" />&nbsp;<input id="Button4" class="C_input" type="button"  style="width:130px;"  value="添加到其他节点" onclick="AddNode('check')" />
