<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_SeachDirectory, App_Web_0mv3apdd" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="left">
        <td width="10%" class="tdbg">欢迎您使用ZoomLa!逐浪CMS系统全文检索功能模块；本系统将帮助您为数据库创建全文索引目录。
