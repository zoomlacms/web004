<%@ page language="C#" autoeventwireup="true" inherits="manage_Lockin, App_Web_rqtvmsdf" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>解锁</title>
...
.loFont{background:url(../App_Themes/AdminDefaultTheme/images/lock_yellow.png) no-repeat;padding-left:128px; width:120px; margin:auto; padding-top:60px; color:#FFF; line-height:18px}
</style>
