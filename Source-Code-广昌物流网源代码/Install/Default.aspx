<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_gay5on1k" responseencoding="utf-8" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>
<asp:CheckBox ID="ChlkAgreeLicense" AutoPostBack="True" OnCheckedChanged="ChlkAgreeLicense_CheckedChanged"	runat="server" /><label for="ChlkAgreeLicense">我已经阅读并同意此协议</label>
</span>
</div>
...
<div class="insbox_txt" style="padding-left:180px;">请确保设置好的数据库中没有旧的数据表和存储过程。</div>

<table cellspacing="0" cellpadding="0" class="ins_date" height="170px">
    <tr>
      <td style="width:135px; height:18px;">请选择数据库版本：</td>
        <td>
    ...
    <tr>
     <td height="18px">数据源：</td>
      <td>
      <asp:TextBox ID="TxtDataSource" runat="server" style="width:220px" Text="(local)"></asp:TextBox>&nbsp;如本地:local 远程为远程主机名!&nbsp;<asp:RequiredFieldValidator ID="ValrDataSource" runat="server" ControlToValidate="TxtDataSource" ErrorMessage="数据源不能为空!"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
    <td headers="15px"></td>
    <td></td>
    ...
    <tr>
      <td height="18px">数据库名称：</td>
       <td>
         <asp:TextBox ID="TxtDataBase" runat="server" Text="ZoomLa" style="width:220px"></asp:TextBox>&nbsp;请确认是否该数据是否存在!&nbsp;<asp:RequiredFieldValidator ID="ValrDataBase" runat="server" ControlToValidate="TxtDataBase" ErrorMessage="数据库名称不能为空!"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
     <td height="18px">数据库用户名称：</td>
     <td>
    <asp:TextBox ID="TxtUserID" runat="server" style="width:220px" Text="ZoomLa"></asp:TextBox>&nbsp;有权限访问该数据库的有效用户名和密码!&nbsp;<asp:RequiredFieldValidator ID="ValrUserID" runat="server" ControlToValidate="TxtUserID" ErrorMessage="数据库用户名称不能为空!"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td height="18px">数据库用户口令：</td>
        <td align="left">
...
<div class="clear"></div>
<div class="biao" style="margin-top:83px;*+margin-top:100px;_margin-top:77px;">
<span style="margin-left:410px; "></span>
</div>
...
<div class="biao" style="margin-top:89px;*margin-top:66px">
...
<div id="bottom">
<ul ><li> &copy; Corpright 2003-<script language="JavaScript" type="text/javascript">
<!--
	var year = "";
	mydate = new Date();
	...
	document.write(year); 
--> 
</script>All rights reserved 逐浪软件zoomla.cn版权所有  经营许可证号:工商3601002021063 </li>
<li>网警备案号:3601040103  商业订购与技术支持热线：021-50391046/50391047/13177777714</li>
</ul>
</div>
</body>
</html>